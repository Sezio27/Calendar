...
class EventViewModel: ObservableObject {
    ...
    func addEvent(title: String, date: Date, details: String, color: EventColor, recurrence: RepeatFrequency, notificationsEnabled: Bool) {
    ...
    func updateEvent(event: EventItem, title: String, date: Date, details: String, color: EventColor, recurrence: RepeatFrequency, notificationsEnabled: Bool) {
        event.title = title
